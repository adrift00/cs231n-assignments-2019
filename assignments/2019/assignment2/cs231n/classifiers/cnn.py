...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        F = num_filters
        FF = filter_size
        self.params['W1'] = np.random.randn(F, C, FF, FF) * weight_scale
        self.params['b1'] = np.zeros(F)

        fc1_input_dim = F * (H // 2) * (W // 2)
        self.params['W2'] = np.random.randn(fc1_input_dim, hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        dout_pool, dW2, db2 = affine_relu_backward(dout_fc1, cache_fc1)
